...
def ask_gemini(question: str) -> str:
    ...
    system_context = """Ты помощник по релизам музыки. Используй эту инструкцию для ответов:
...
Отвечай кратко и по делу. Если не знаешь ответ - скажи, что поищешь в интернете."""
