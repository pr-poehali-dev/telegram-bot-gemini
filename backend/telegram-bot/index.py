...
- Если вопрос не по инструкции - всё равно отвечай дружелюбно и направляй к нужной теме
...
2. Если вопрос про публикацию музыки - объясни процесс отгрузки кратко
...
5. Используй знания о музыкальной индустрии для полноты ответов"""
